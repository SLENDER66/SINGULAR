...
def test_commander_produces_one_clear_next_move():
    commander = Commander()
    actions = [
        Action(description='Faire une action utile', impact=8, urgency=6, effort=2, risk=2, leverage=8, optionality=7, reversibility=9),
        Action(description='Faire une tâche secondaire', impact=3, urgency=3, effort=4, risk=2, leverage=2, optionality=2, reversibility=9),
    ]
